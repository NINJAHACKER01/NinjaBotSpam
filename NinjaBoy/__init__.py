...
bot = TelegramClient('NinjaBoy', APP_ID, API_HASH).start(bot_token=BOT_TOKEN) 
bot2 = TelegramClient('NinjaBoy2', APP_ID, API_HASH).start(bot_token=BOT_TOKEN2) 
bot3 = TelegramClient('NinjaBoy3', APP_ID, API_HASH).start(bot_token=BOT_TOKEN3) 
bot4 = TelegramClient('NinjaBoy4', APP_ID, API_HASH).start(bot_token=BOT_TOKEN4) 
bot5 = TelegramClient('NinjaBoy5', APP_ID, API_HASH).start(bot_token=BOT_TOKEN5) 
bot6 = TelegramClient('NinjaBoy6', APP_ID, API_HASH).start(bot_token=BOT_TOKEN6) 
bot7 = TelegramClient('NinjaBoy7', APP_ID, API_HASH).start(bot_token=BOT_TOKEN7) 
bot8 = TelegramClient('NinjaBoy8', APP_ID, API_HASH).start(bot_token=BOT_TOKEN8) 
bot9 = TelegramClient('NinjaBoy9', APP_ID, API_HASH).start(bot_token=BOT_TOKEN9) 
bot10 = TelegramClient('NinjaBoy10', APP_ID, API_HASH).start(bot_token=BOT_TOKEN10)
